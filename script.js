document.addEventListener('DOMContentLoaded', () => {
    ...
    const lyrics = [
        { time: 0, text: "Lembaran foto hitam putih" },
        { time: 7, text: "Aku coba ingat lagi warna bajumu kala itu" },
        { time: 13, text: "Kali pertama di hidupku" },
        { time: 18, text: "Manusia lain memelukku" },
        { time: 24, text: "Lembaran foto hitam-putih" },
        { time: 28, text: "Aku coba ingat lagi wangi rumah di sore itu" },
        { time: 35, text: "Kue coklat, balon warna-warni" },
        { time: 40, text: "Pesta hari ulang tahunku" },
        { time: 45, text: "Di mana pun kalian berada" },
        { time: 51, text: "Kukirimkan terima kasih" },
        { time: 56, text: "Untuk warna dalam hidupku dan banyak kenangan indah" },
        { time: 62, text: "Kau melukis aku" },
    ];
